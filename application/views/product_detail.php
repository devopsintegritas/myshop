...
<div class="col-12">
    <?php  $images = explode('|', $product_detail['product_images']); ?>
    <main class="row">
        <div class="col-12 bg-white py-3 my-3">
            <div class="row">
                <div class="col-lg-5 col-md-12 mb-3">
                    <div class="col-12 mb-3">
                        <div class="img-large border" style="background-image: url('assets/images/<?php echo $images[0] ?>')"></div>
                    </div>
                    <div class="col-12">
                        <div class="row">
                            <?php
                            if(count($images) > 1)  {
                                for ($i=1; $i < count($images); $i++) {
                                    echo "<div class='col-sm-2 col-3'>";
                                        echo "<div class='img-small border' style='background-image: url(assets/images/".$images[$i].")'  data-src='assets/images/".$images[$i]."'></div>";
                                    echo "</div>";        
                                }
                            }else {
                                echo "<div class='col-sm-2 col-3'>";
                                    echo "<div class='img-small border' style='background-image: url(assets/images/".$images[0].")' data-src='assets/images/".$images[0]."'></div>";
                                echo "</div>";
                            }
                            ?>
                        </div>
                ...
                <div class="col-lg-5 col-md-9">
                    ...
                    <div class="col-12">
                        <ul>
                            <li><?php echo $product_detail['product_discription']; ?></li>
                        </ul>
                    </div>
                </div>
                <!-- Product Info -->
                    ...
                    <div class="col-12 border-left border-top sidebar h-100">
                        <div class="row">
                            ...
                            <span class="detail-price">
                                <i class="fa fa-inr"></i><?php echo $product_detail['product_cost']; ?>
                            </span>
                                <span class="detail-price-old">
                                <i class="fa fa-inr"></i><?php echo $product_detail['display_cost']; ?>
                            </span>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                <button class="btn btn-outline-dark addToCart" data-product_details='<?php echo json_encode($product_detail); ?>' type="button"><i class="fas fa-cart-plus mr-2"></i>Add to cart</button>
                            </div>
                            <div class="col-12 mt-3">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12" id="details">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam imperdiet vel ligula vel sodales. Aenean vel ullamcorper purus, ac pharetra arcu. Nam enim velit, ultricies eu orci nec, aliquam efficitur sem. Quisque in sapien a sem vestibulum volutpat at eu nibh. Suspendisse eget est metus</p>
